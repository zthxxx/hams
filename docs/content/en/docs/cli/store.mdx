...
Stage, commit, and push Hamsfile changes in a single step. Let hams generate a commit message
from the diff, or pass your own.
...
# Only the current profile's changes (skip cross-profile edits for now)
