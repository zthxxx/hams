...
func TestCatalogCoherence_EveryTypedKeyResolves(t *testing.T) {
	...
	typedKeys := []string{
		...
		CLIErrNoPositionalArgs,
		CLIErrNoPositionalArgsSuggestFilter,
		CLIErrNoPositionalArgsSuggestAll,
		CLIErrOnlyExceptConflict,
		CLIErrOnlyExceptConflictSuggest,
		CLIErrBootstrapModeConflict,
		CLIErrBootstrapModeConflictSuggest,
		CLIErrFromRepoStoreConflict,
		CLIErrStorePathInvalid,
		CLIErrStorePathInvalidSuggestFix,
		CLIErrProfileNotFound,
		CLIErrProfileNotFoundSuggestList,
		CLIErrProfileNotFoundSuggestCreate,
		CLIErrConfigFileMissing,
		CLIErrConfigFileMissingSuggestCheck,
		CLIErrConfigFileMissingSuggestCreate,
		CLIErrConfigFileMissingSuggestDefault,
		CLIErrOnlyEmpty,
		CLIErrExceptEmpty,
		CLIErrUnknownProvider,
		CLIErrUnknownProviderSuggestList,
		CLIErrProfileNotConfigured,
		CLIErrSudoAcquisitionFailed,
		CLIErrSudoAcquisitionFailedSuggestReenter,
		CLIErrSudoAcquisitionFailedSuggestPasswordless,
		CLIErrSudoAcquisitionFailedSuggestFilter,
		CLIErrInterrupted,
		CLIErrInterruptedSuggestInspect,
		CLIErrInterruptedSuggestRerun,
		// apply extras
		ApplyExecutionOrderHeader,
		ApplyBootstrapDryRun,
		ApplyNoProvidersStateOnly,
		ApplyNoProvidersFiltered,
		ApplyNoProvidersOnlyMissing,
		ApplyNoProvidersProfileLine,
		ApplyNoProvidersSuggestInstall,
		ApplyNoProvidersProfileDirMissing,
		ApplyNoProvidersAvailableProfiles,
		ApplyNoProvidersSuggestProfileFix,
		ApplySummaryComplete,
		ApplySummaryFailedWarning,
		ApplySummaryFailedWarningSuggest,
		ApplySummarySkippedWarning,
		ApplySummaryStateFailWarning,
		ApplySummaryStateFailSuggest,
		ApplySummaryPartialFailureErr,
		ApplySummaryPartialFailureSuggestRetry,
		ApplySummaryPartialFailureSuggestDebug,
		ApplyDryRunNoChanges,
		ApplyDryRunPerProviderHeader,
		ApplyDryRunNoChangesProvider,
		ApplyDryRunUnchangedTail,
		ApplyDryRunStateFailErr,
		ApplyDryRunStateFailErrSuggestPerms,
		ApplyDryRunStateFailErrSuggestNoRefresh,
		ApplyDryRunSkippedErr,
		ApplyDryRunSkippedErrSuggestFix,
		ApplyStateFailDriftLine,
		ApplyNotFoundProfile,
		ApplyProfileTagPrompt,
		ApplyProfileMachineIDPrompt,
		// refresh extras
		RefreshSummaryComplete,
		RefreshSummaryCompleteWithSaveFails,
		RefreshSummaryCompleteWithProbeFails,
		RefreshSummarySaveFailWarning,
		RefreshInterrupted,
		RefreshStateWrittenHeader,
		// store
		StoreNothingToCommit,
		StoreStatusPathMissing,
		StoreStatusPathMissingLine1,
		StoreStatusPathMissingLine2,
		StoreStatusPath,
		StoreStatusProfileTag,
		StoreStatusMachineID,
		StoreStatusProfileDir,
		StoreStatusStateDir,
		StoreStatusHamsfiles,
		StoreStatusHamsfilesMissing,
		StoreStatusGit,
		StoreInitDryRunHeader,
		StoreInitDryRunProfileDir,
		StoreInitDryRunStateDir,
		StoreInitDryRunConfigFile,
		StoreInitDryRunGitignore,
		StoreInitDryRunPromptNotice,
		StoreInitDone,
		StoreInitDoneProfileDir,
		StoreInitDoneStateDir,
		StoreInitDoneGitignore,
		StorePullDryRun,
		StoreCommitDryRun,
		// config
		ConfigHomeLine,
		ConfigDataHomeLine,
		ConfigGlobalConfigLine,
		ConfigLocalOverridesLine,
		ConfigProfileTagLine,
		ConfigMachineIDLine,
		ConfigStorePathLine,
		ConfigStoreRepoLine,
		ConfigLLMCLILine,
		ConfigProviderPriorityLine,
		ConfigSetDryRun,
		ConfigSetDone,
		ConfigUnsetDryRun,
		ConfigUnsetDone,
		ConfigOpenDryRun,
		ConfigOpenDryRunStub,
		// list
		ListNoResourcesFilter,
		ListNoResourcesStatus,
		ListNoResourcesEmpty,
		ListNoResourcesEmptyLine1,
		ListNoResourcesEmptyLine2,
		ListGroupHeader,
		// upgrade
		UpgradeBrewDryRun,
		UpgradeBrewDetected,
		...
		ProviderErrNoStore,
		ProviderErrNoStoreSuggest,
		ProviderErrInstallNeedsPackage,
		ProviderErrInstallNeedsPackageUsage,
		ProviderErrInstallNeedsPackageBulk,
		ProviderErrInstallNeedsPackageAtLeastOne,
		ProviderErrRemoveNeedsPackage,
		ProviderErrRemoveNeedsPackageUsage,
		ProviderErrRemoveNeedsPackageAtLeastOne,
		ProviderErrUnknownSubcommand,
		// provider dry-run status
		ProviderStatusDryRunInstall,
		ProviderStatusDryRunRemove,
		ProviderStatusDryRunRun,
		// provider list
		ProviderListHomebrewHeader,
		ProviderListGitCloneHeader,
		ProviderListGitCloneEmpty,
		// git extras
		GitConfigSetDryRun,
		GitConfigUnsetDryRun,
		GitCloneDryRun,
		GitCloneRemoveDryRun,
		// sudo
		SudoPrompt,
		// tui
		TUIWarnNoTTY,
		// bootstrap
		BootstrapCloneDryRun,
		BootstrapDownloading,
		BootstrapDownloadSuccess,
		BootstrapProfileNow,
		// errors rendering
		ErrorsPrefix,
		ErrorsSuggestionPrefix,
		// provider help
		ProviderHelpTitle,
		ProviderHelpUsage,
		ProviderHelpUsageLine,
		ProviderHelpDescribed,
		ProviderHelpHamsPrefix,
		ProviderHelpDoubleDash,
	}
