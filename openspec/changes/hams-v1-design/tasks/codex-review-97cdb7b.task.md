...
- [x] **CR-1: Use provider-specific planning during apply** (`internal/cli/apply.go:163-166`)
...
- [x] **CR-2: Locate Hamsfiles with the manifest file prefix** (`internal/cli/apply.go:142-145`)
...
- [x] **CR-3: Bootstrap providers before probing or applying** (`internal/cli/apply.go:120-127`)
...
- [x] **CR-4: Persist CLI installs into the store** (`internal/provider/builtin/homebrew/homebrew.go:155-163`)
...
- [x] **CR-5: Save refreshed state to disk** (`internal/cli/commands.go:46-47`)
