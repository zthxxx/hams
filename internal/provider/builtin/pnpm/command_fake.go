...
// synthesizes the pnpm-list JSON shape from the virtual installed set
...
// JSON shape from the virtual installed set.
...
// CallCount returns how many times op was invoked. pkg filters by
